"""Schedule W23 Day-12 Pinterest pins (2026-05-25) via Buffer API.
G18: 300dpi-test      — Why your print looks blurry. 72 vs 300 DPI explained. (Gemini)
G19: quick-export-dm  — Buyer DM'd asking for 5x7. Fix it in 8 seconds. (Gemini)
P20: dpi-cheatsheet   — 300 DPI cheat sheet — every Etsy print size + pixel dimensions. (React)
"""
...
PINS = [
    ...
    },
    {
        ...
        "board":   "digital-prints",
        "due_at":  "2026-05-25T16:00:00Z",
    },
    {
        "item_id": "W23-P20",
        "slug":    "2026-05-24-dpi-cheatsheet-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-25T19:00:00Z",
    },
]

dry_run = "--dry-run" in sys.argv
print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-12 pins...\n")
