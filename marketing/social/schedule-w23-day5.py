"""Schedule W23 Day-5 Pinterest pins (2026-05-16) via Buffer API.
G4: extras-pack-sizes    — 6 sizes most sellers skip (Gemini)
G5: one-file-8-countries — 1 file, 8 countries covered (Gemini)
P13: owl-neon-pack       — NeonPackShowcase owl (React)
"""
...
PINS = [
    {
        ...
        "due_at":  "2026-05-17T13:00:00Z",  # 3pm GMT+2
    },
    {
        "item_id": "W23-G5",
    ...
    {
        "item_id": "W23-P13",
        "slug":    "2026-05-16-owl-neon-pack-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-17T19:00:00Z",  # 9pm GMT+2
    },
]

dry_run = "--dry-run" in sys.argv

print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-5 pins...\n")
