"""Schedule W23 Day-5 Instagram posts (2026-05-16) via Buffer API.
IG04: extras-pack-sizes    — 6 sizes most sellers skip (Gemini, 4:5)
IG05: one-file-8-countries — 1 file, 8 countries covered (Gemini, 4:5)
"""
...
POSTS = [
    {
        "item_id": "W23-IG04",
        "slug":    "2026-05-16-extras-pack-sizes-instagram",
        "due_at":  "2026-05-17T09:00:00Z",  # 11am GMT+2
    },
    {
        "item_id": "W23-IG05",
        "slug":    "2026-05-16-one-file-8-countries-instagram",
        "due_at":  "2026-05-17T16:00:00Z",  # 6pm GMT+2
    },
]

dry_run = "--dry-run" in sys.argv

print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(POSTS)} W23 Day-5 Instagram posts...\n")
...
for post in POSTS:
    ...
    if dry_run:
        print(f"  DRY RUN -- would schedule to Buffer Instagram")
    ...
    item_dict = {
        ...
        "platform": "instagram",
        "format": "image",
        "files": {"image": f"content/instagram/{slug}/{asset_file.name}"},
    }
