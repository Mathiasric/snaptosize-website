"""Schedule W23 Day-9 Pinterest pins (2026-05-20) via Buffer API.
G12: zip-too-big          — Etsy rejects ZIPs over 20MB. (Gemini)
G13: canva-vs-snaptosize  — Design tools export one size. Your buyers need six. (Gemini)
P17: price-ladder         — What buyers actually pay per print size. (React)
"""
...
PINS = [
    {
        ...
        "due_at":  "2026-05-21T13:00:00Z",
    },
    {
        "item_id": "W23-G13",
        "slug":    "2026-05-20-canva-vs-snaptosize-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-21T16:00:00Z",
    },
    {
        "item_id": "W23-P17",
        "slug":    "2026-05-20-price-ladder-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-21T19:00:00Z",
    },
]

dry_run = "--dry-run" in sys.argv
print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-9 pins...\n")
