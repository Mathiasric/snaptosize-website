"""Schedule W23 Day-7 Pinterest pins (2026-05-18) via Buffer API.
G8: 3-hours-vs-5-minutes       — 3 hours in Photoshop. Or 5 minutes with SnapToSize. (Gemini)
G9: portrait-and-landscape     — Portrait frames. Landscape frames too. (Gemini)
P15: deer-neon-pack            — Deer Portrait — Neon Pack Showcase (React)
"""
...
PINS = [
    {
        ...
        "due_at":  "2026-05-19T13:00:00Z",  # 3pm GMT+2
    },
    {
        "item_id": "W23-G9",
        "slug":    "2026-05-18-portrait-and-landscape-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-19T16:00:00Z",  # 6pm GMT+2
    },
    {
        "item_id": "W23-P15",
        "slug":    "2026-05-18-deer-neon-pack-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-19T19:00:00Z",  # 9pm GMT+2
    },
]

dry_run = "--dry-run" in sys.argv

print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-7 pins...\n")
