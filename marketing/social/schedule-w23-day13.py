"""Schedule W23 Day-13 Pinterest pins (2026-05-27) via Buffer API.
G21: zip-rejected         — Your ZIP is 20.4MB. Etsy's limit is 20MB. (Gemini)
G22: landscape-portrait   — Portrait AND landscape. One upload. 140 files. (Gemini)
P22: fox-pack-showcase    — Your art in every Etsy ratio — done. (React)
"""
...
PINS = [
    ...
    },
    {
        ...
        "board":   "digital-prints",
        "due_at":  "2026-05-27T16:00:00Z",
    },
    {
        "item_id": "W23-P22",
        "slug":    "2026-05-26-fox-pack-showcase-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-27T19:00:00Z",
    },
]

dry_run = "--dry-run" in sys.argv
print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-13 pins...\n")
