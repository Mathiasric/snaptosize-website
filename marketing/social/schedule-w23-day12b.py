"""Schedule W23 Day-12b Pinterest pins (2026-05-25) via Buffer API.
G20: complete-listing  — Same artwork. 5 packs. 70 files. (Gemini)
P21: ratio-packs-pin   — Every ratio. One upload. (React W22RatioPacksPin)
"""
...
PINS = [
    ...
    {
        "item_id": "W23-P21",
        "slug":    "2026-05-24-ratio-packs-pin-pinterest",
        "board":   "digital-prints",
...
print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-12b pins...\n")
