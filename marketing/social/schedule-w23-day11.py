"""Schedule W23 Day-11 Pinterest pins (2026-05-23) via Buffer API.
G16: my-packs         — Build your size set once. Apply it forever. (Gemini)
G17: 8x10-buyer       — The 8x10 blind spot. Most sellers don't list it. (Gemini)
P19: top5-frame-fit   — 5 Etsy print sizes that fit the frames buyers already own. (React)
"""
...
PINS = [
    ...
    {
        "item_id": "W23-P19",
        "slug":    "2026-05-23-top5-frame-fit-pinterest",
        "board":   "digital-prints",
        "due_at":  "2026-05-23T19:00:00Z",
    },
]

dry_run = "--dry-run" in sys.argv
print(f"{'DRY RUN -- ' if dry_run else ''}Scheduling {len(PINS)} W23 Day-11 pins...\n")
