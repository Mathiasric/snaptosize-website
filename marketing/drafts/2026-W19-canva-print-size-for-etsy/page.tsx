...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        { "@type": "Question", name: "What size canvas should I use in Canva for Etsy printables?", acceptedAnswer: { "@type": "Answer", text: "Start with a 6000×4500 pixel custom canvas in Canva — this is a 4:5 master at 300 DPI that scales down cleanly to 8×10, 16×20, 11×14, and other 4:5 sizes. For 2:3 Etsy prints, use 6000×4000 px. For A-series (ISO), use 6250×8839 px (A3 at 300 DPI). Always export as PDF Print for true 300 DPI." } },
        { "@type": "Question", name: "Is Canva 300 DPI by default?", acceptedAnswer: { "@type": "Answer", text: "No. Canva's PNG and JPG exports default to 96 DPI — fine for screens but pixelated when printed. You have to export as PDF Print to get true 300 DPI output. Canva Pro lets you toggle PNG at higher resolutions, but PDF Print is the safest 300 DPI path for Etsy printables." } },
        ...
        { "@type": "Question", name: "What DPI does Canva export PNG at?", acceptedAnswer: { "@type": "Answer", text: "Canva Free exports PNG at 96 DPI (screen resolution). Canva Pro allows PNG export at custom DPI up to 300. For Etsy printables, either upgrade to Pro or use PDF Print export — which is 300 DPI on all plans." } },
        ...
        { "@type": "Question", name: "Can Canva create all 5 ratio packs automatically for Etsy?", acceptedAnswer: { "@type": "Answer", text: "No. Canva has no batch-export-by-ratio feature. You'd need to manually resize the canvas for every ratio (2:3, 3:4, 4:5, ISO) and re-export each one. SnapToSize takes a single Canva export and generates all five ratio packs in one upload." } },
...
const faqItems = [
  ...
  { question: "Is Canva 300 DPI by default?", answer: "No. Canva's PNG and JPG exports default to 96 DPI — fine for screens but pixelated when printed. You have to export as PDF Print to get true 300 DPI output. Canva Pro lets you toggle PNG at higher resolutions, but PDF Print is the safest 300 DPI path for Etsy printables." },
  ...
  { question: "What DPI does Canva export PNG at?", answer: "Canva Free exports PNG at 96 DPI (screen resolution). Canva Pro allows PNG export at custom DPI up to 300. For Etsy printables, either upgrade to Pro or use PDF Print export — which is 300 DPI on all plans." },
  ...
  { question: "Can Canva create all 5 ratio packs automatically for Etsy?", answer: "No. Canva has no batch-export-by-ratio feature. You'd need to manually resize the canvas for every ratio (2:3, 3:4, 4:5, ISO) and re-export each one. SnapToSize takes a single Canva export and generates all five ratio packs in one upload." },
          ...
          <div className="max-w-[620px]">
            ...
            <h1 className="font-bold tracking-tight mb-5">
              ...
              <span className="block text-xl md:text-2xl lg:text-[1.65rem] font-semibold text-foreground-70">
                Exact canvas dimensions, DPI truth, and the ratio-pack workflow
              </span>
            </h1>

            <p className="text-base mb-6 max-w-lg leading-relaxed text-foreground-70">
              Designing in Canva for your Etsy shop? Here&apos;s the exact canvas size to start with, why your PNG exports look pixelated, and how to turn one Canva file into every Etsy ratio pack &mdash; without duplicating your design ten times.
            </p>

            <div className="mb-5">
              <a href={appUrl} target="_blank" rel="noopener noreferrer">
                <Button className="gap-2 text-sm px-6 py-2.5">
                  Resize Your Canva Export — Free
                  <ArrowRight className="w-4 h-4" />
                </Button>
              </a>
              <p className="text-sm mt-2 text-foreground-60">
                Upload your Canva PDF or PNG &rarr; get every Etsy ratio in one click.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                "96 vs 300 DPI explained",
                "Every ratio pack covered",
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px] pt-16 pb-12 md:pt-20">
        ...
        <div className="mb-16 md:mb-20">
          <QuickAnswer question="What's the right Canva print size for Etsy?">
            Start with a <strong>6000×4500 pixel custom canvas</strong> in Canva (4:5 master at 300 DPI). Export as <strong>PDF Print</strong> — not PNG, which defaults to 96 DPI. This one file scales cleanly to 8×10, 11×14, 16×20, and every other 4:5 Etsy size. For 2:3 (8×12, 24×36), use 6000×4000 px. For ISO (A4, A3), use 6250×8839 px.
          </QuickAnswer>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="overflow-x-auto mb-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  { ratio: "4:5", size: "6000 × 4500 px", covers: "8×10, 11×14, 16×20, 20×24" },
                  { ratio: "2:3", size: "6000 × 4000 px", covers: "4×6, 8×12, 12×18, 20×30, 24×36" },
                  { ratio: "3:4", size: "6000 × 4500 px", covers: "6×8, 9×12, 12×16, 18×24" },
                  { ratio: "ISO (A3)", size: "6250 × 8839 px", covers: "A5, A4, A3, A2, A1" },
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-6">
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-rose-300">PNG / JPG (Free) → 96 DPI</span>
              </div>
              <ul className="space-y-2 text-sm text-foreground-70">
                <li className="flex gap-2"><span className="w-4 shrink-0 text-rose-400">×</span>Canva Free PNG = 96 DPI by default</li>
        ...
        <section className="mb-16">
          ...
          <ol className="space-y-4 mb-6">
            {[
              { step: "1", title: "Design once at 4:5 master (6000×4500 px)", desc: "This covers 80% of US Etsy buyers — 8×10, 11×14, 16×20, 20×24." },
              { step: "2", title: "Duplicate the Canva design and resize to 2:3 (6000×4000)", desc: "Extend your background, shift key elements so nothing gets cropped. This covers 8×12, 12×18, 24×36." },
              { step: "3", title: "Duplicate again for ISO (6250×8839 px — A3 master)", desc: "Required for European A4/A3/A5 buyers. Without ISO you lose ~25% of international orders." },
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 mb-6">
            {[
              ...
              {
                title: "PNG export at 96 DPI shipped to buyer",
                cause: "Canva Free PNG defaults to 96 DPI — three times less resolution than print standard. Always use PDF Print export instead.",
              },
              {
        ...
        <section className="mb-16">
          ...
          <ul className="space-y-3 mb-6">
            {[
              ...
              { title: "No automatic ISO conversion", desc: "Converting a 6000×4500 4:5 canvas to A3 (ISO) requires manual background extension and recomposition." },
              { title: "No batch-export-by-ratio feature", desc: "Every Etsy size needs a separate export click. Ten sizes across four ratios = 40 manual exports per design." },
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  { feat: "PNG at custom DPI", free: "Locked to 96 DPI", pro: "Up to 300 DPI" },
