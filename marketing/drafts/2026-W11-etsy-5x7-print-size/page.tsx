        ...
        <div className="absolute right-[8%] top-1/2 -translate-y-1/2 hidden md:block">
          ...
          >
            ...
            <div className="absolute top-2 right-3">
              <span className="text-[9px] font-mono text-white/15 tracking-wider">8×10 frame</span>
            </div>
            ...
            <div
              className="absolute border-2 border-purple-400/25 rounded-sm"
              style={{
                width: "180px",
                height: "252px",
                top: "50%",
            ...
            >
              {/* Inner accent border */}
              <div className="absolute inset-2 border border-purple-500/15 rounded-sm" />

              {/* Small rounded corner accents (different from 8×10's sharp corners) */}
              <div className="absolute -top-1.5 -left-1.5 w-3 h-3 border-t-2 border-l-2 border-purple-400/40 rounded-tl-sm" />
              <div className="absolute -top-1.5 -right-1.5 w-3 h-3 border-t-2 border-r-2 border-purple-400/40 rounded-tr-sm" />
              <div className="absolute -bottom-1.5 -left-1.5 w-3 h-3 border-b-2 border-l-2 border-purple-400/40 rounded-bl-sm" />
              <div className="absolute -bottom-1.5 -right-1.5 w-3 h-3 border-b-2 border-r-2 border-purple-400/40 rounded-br-sm" />

              {/* Ratio badge */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="px-3 py-1.5 rounded-full border border-purple-400/15 bg-purple-500/[0.04]">
                  <span className="text-xs font-mono text-purple-300/30 tracking-[0.2em]">
                    5 : 7
                  </span>
                </div>
              </div>
          ...
          <div className="max-w-3xl mx-auto space-y-16">
            ...
            <div>
              ...
              <p className="text-foreground-60">
                ...
                alongside other popular &ldquo;odd&rdquo; sizes like 8.5×11 (US
                Letter), 11×14, 11×17, and 20×24. These are all sizes buyers
            ...
            <div>
              <a href={appUrl} target="_blank" rel="noopener noreferrer">
                <Button className="text-base px-6 py-2.5">
                  Generate 5×7 + All Sizes in Seconds
                </Button>
              </a>
            </div>
            ...
            <div>
              <Card accent className="p-6 md:p-8 text-center">
                <h3 className="text-xl md:text-2xl font-bold mb-3">
                  Get 5×7 + All 30 Sizes in One Click
                </h3>
                <p className="text-sm text-foreground-60 mb-5">
                  Upload your artwork and instantly receive 5×7, 8×10, 4×6, and
                  27 more sizes across every ratio at 300&nbsp;DPI. No cropping,
                  no manual resizing. Production-ready in seconds.
                </p>
                <a href={appUrl} target="_blank" rel="noopener noreferrer">
              ...
              <FAQAccordion
                items={[
                  ...
                  },
                  {
                    ...
                    answer:
                      "5×7 has its own unique shape (5:7 ratio) — it's narrower than 8×10 and wider than 4×6. You can't just resize between these sizes without cutting off part of your design. Because of its unique shape, SnapToSize includes 5×7 in the Extras pack alongside 8.5×11, 11×14, 11×17, and 20×24.",
                  },
                  {
            ...
            <div>
              <Card accent className="p-6 md:p-8">
                <div className="max-w-xl mx-auto text-center">
                  ...
                  <p className="text-sm text-foreground-60 mb-5">
                    All 30 Etsy sizes and pixel dimensions at 300 DPI in one
                    PDF. Plus file naming conventions and best practices.
                  </p>
                  <EmailCapture
