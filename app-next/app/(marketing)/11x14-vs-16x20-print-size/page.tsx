    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-16">
        ...
        <ComparisonProof
          ...
          a={{ src: "/assets/modes-demo/ratios/misty-extras.jpg", label: "11×14", px: "3300 × 4200", ratio: "11:14", aspect: "11/14", h: "h-40 sm:h-52" }}
          b={{ src: "/assets/modes-demo/ratios/misty-4x5.jpg", label: "16×20", px: "4800 × 6000", ratio: "4:5", aspect: "4/5", h: "h-44 sm:h-56" }}
          note="Upload once. SnapToSize exports 11×14 and 16×20 at 300 DPI — the full image kept, no cropping, every file under 20MB."
        />
