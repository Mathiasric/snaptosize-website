    ...
    <>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px] pt-16 pb-12 md:pt-20">
        ...
        <section className="mb-16">
          <ListingOutputShowcase
            artwork="misty_lake"
            heading="One kitchen design. Every ratio pack."
            subtext="SnapToSize takes a single design and generates 2:3, 3:4, 4:5, and ISO — 5×7, 8×10, 6×8, 11×14, 16×20, A4 — in a single upload, ready to attach to your Etsy listing."
          />
        </section>
