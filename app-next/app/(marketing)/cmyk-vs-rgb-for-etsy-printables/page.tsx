...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/assets/og/cmyk-vs-rgb-for-etsy-printables.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/assets/og/cmyk-vs-rgb-for-etsy-printables.png"],
  },
};
...
export default function CmykVsRgbForEtsyPrintablesPage() {
  const articleJsonLd = {
    ...
    image:
      "https://snaptosize.com/assets/og/cmyk-vs-rgb-for-etsy-printables.png",
  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden bg-slate-950">
        ...
        />
        {/* Color-mode visual analogy — RGB (additive) vs CMYK (subtractive) */}
        <div className="absolute right-4 md:right-16 top-1/2 -translate-y-1/2 hidden lg:block select-none pointer-events-none">
          <div className="relative" style={{ width: "360px", height: "260px" }}>
            {/* RGB stack */}
            <div className="absolute" style={{ left: "0", top: "0" }}>
              <svg width="170" height="200" viewBox="0 0 170 200" fill="none" style={{ opacity: 0.5 }}>
                <circle cx="65" cy="70" r="42" fill="#ef4444" fillOpacity="0.7" style={{ mixBlendMode: "screen" }} />
                <circle cx="105" cy="70" r="42" fill="#22c55e" fillOpacity="0.7" style={{ mixBlendMode: "screen" }} />
                <circle cx="85" cy="105" r="42" fill="#3b82f6" fillOpacity="0.7" style={{ mixBlendMode: "screen" }} />
              </svg>
              <div className="absolute inset-x-0 bottom-0 text-center">
                <div className="text-[10px] font-mono tracking-widest uppercase" style={{ color: "rgba(45,212,191,0.9)" }}>RGB</div>
                <div className="text-[9px] font-mono mt-0.5" style={{ color: "rgba(240,238,250,0.5)" }}>additive · screens</div>
              </div>
            </div>
            ...
            <div
              ...
              style={{ left: "172px", top: "92px", color: "rgba(167,139,250,0.6)" }}
            >
              vs
            </div>

            {/* CMYK stack */}
            <div className="absolute" style={{ left: "200px", top: "0" }}>
              <svg width="160" height="200" viewBox="0 0 160 200" fill="none" style={{ opacity: 0.45 }}>
                <circle cx="60" cy="60" r="38" fill="#06b6d4" fillOpacity="0.75" style={{ mixBlendMode: "multiply" }} />
                <circle cx="100" cy="60" r="38" fill="#ec4899" fillOpacity="0.75" style={{ mixBlendMode: "multiply" }} />
                <circle cx="60" cy="100" r="38" fill="#facc15" fillOpacity="0.75" style={{ mixBlendMode: "multiply" }} />
                <circle cx="100" cy="100" r="38" fill="#1f2937" fillOpacity="0.85" style={{ mixBlendMode: "multiply" }} />
              </svg>
              <div className="absolute inset-x-0 bottom-0 text-center">
                <div className="text-[10px] font-mono tracking-widest uppercase" style={{ color: "rgba(167,139,250,0.9)" }}>CMYK</div>
                <div className="text-[9px] font-mono mt-0.5" style={{ color: "rgba(240,238,250,0.5)" }}>subtractive · ink</div>
              </div>
            </div>

            {/* Bottom caption */}
            <div
              className="absolute text-[9px] font-mono tracking-widest uppercase text-center"
              style={{ bottom: "-14px", left: "50%", transform: "translateX(-50%)", color: "rgba(45,212,191,0.45)", whiteSpace: "nowrap" }}
            >
              Etsy = digital files = sRGB
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-[1200px] py-12">
        ...
        <div className="mb-10">
          <QuickAnswer question="Should Etsy printables be CMYK or RGB?">
            <p>
              <strong>RGB — specifically sRGB.</strong> Etsy buyers print on home inkjets and
              consumer photo labs (Walgreens, Costco, Snapfish), and every one of them expects RGB
              input. CMYK files almost always print muddier and darker. Export sRGB at{" "}
              <Link href="/best-resolution-for-etsy-printables" className="text-teal-400 underline underline-offset-2">
                300 DPI
              </Link>
              , and you've covered 90% of color complaints.
            </p>
          </QuickAnswer>
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-foreground-60 mt-4">
            <span className="inline-flex items-center gap-2"><span className="text-[#2DD4BF]">✓</span> sRGB IEC61966-2.1</span>
            <span className="inline-flex items-center gap-2"><span className="text-[#2DD4BF]">✓</span> Home printer-safe</span>
            <span className="inline-flex items-center gap-2"><span className="text-[#2DD4BF]">✓</span> Used by Etsy printable sellers</span>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="my-6 border-l-4 border-l-[#A78BFA] bg-white/[0.03] rounded-r-lg p-5">
            <p className="text-foreground italic leading-relaxed">
              &ldquo;Sending a pre-converted CMYK file forces the home printer to convert a
              <strong> second time</strong> — that&apos;s where muddy, dark, off-color prints come from.&rdquo;
            </p>
          </div>
          <p className="text-foreground-60 mb-4 leading-relaxed">
