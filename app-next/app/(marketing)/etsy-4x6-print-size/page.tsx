        ...
        <Container>
          ...
          <div className="relative z-10 mt-12 md:mt-14 border-t border-white/[0.06] pt-10">
            <SizeLadder
              ...
              zipMeta="4×6 · 12×18 · 24×36 · under 20 MB"
              rungs={[
                { id: "4x6", label: "4×6", px: "1200 × 1800", sub: "photo & card size", h: "h-24 sm:h-32", accent: true },
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-60 text-sm">
                        ...
                        ) is 4:5 ratio. A crop between these ratios leaves off
                        the edges of your artwork (only stretching distorts it).
                        Design at 2:3 from the start for the 4&times;6 family, use
                        a tool that generates each ratio separately, or let{" "}
                        <Link
                        ...
                        {" "}make a controlled, distortion-free crop to the exact
                        2:3 ratio &mdash; while Size Packs keeps the whole image
