        ...
        <Container>
          ...
          <div className="relative z-10 mt-12 md:mt-14 border-t border-white/[0.06] pt-10">
            <SizeLadder
              ...
              zipMeta="8×12 · 12×18 · 24×36 · under 20 MB"
              rungs={[
                { id: "8x12", label: "8×12", px: "2400 × 3600", sub: "standard print", h: "h-24 sm:h-32" },
                { id: "12x18", label: "12×18", px: "3600 × 5400", sub: "gallery wall art", h: "h-32 sm:h-44", accent: true },
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-60 text-sm">
                        ...
                        cropping. If you do need to fit non-2:3 art into
                        12&times;18,{" "}
                        <Link
                        ...
                        lets you control exactly what stays in frame &mdash; a
                        clean crop, never a stretch.
                      </p>
                    </div>
                  </div>
                </Card>
