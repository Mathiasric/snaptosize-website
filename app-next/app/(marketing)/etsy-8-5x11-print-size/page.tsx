          ...
          <div className="max-w-3xl mx-auto space-y-16">
            ...
            <div>
              ...
              <div className="rounded-xl overflow-hidden border border-white/[0.08]">
                <img
                  src="/assets/visuals/etsy-8-5x11-size-comparison.png"
                  alt="8.5×11 US Letter size comparison with A5, 8×10, A4, and 11×14"
                  width={1200}
                  height={500}
            ...
            <ContextualCTA
              problem="Still exporting 8.5×11 files manually for every listing?"
              solution="Upload once, get US Letter plus 29 other sizes at 300 DPI. Organized in ratio packs, ready for Etsy."
              appUrl={appUrl}
