    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-16">
        ...
        <ComparisonProof
          ...
          a={{ src: "/assets/modes-demo/ratios/misty-3x4.jpg", label: "18×24", px: "5400 × 7200", ratio: "3:4", aspect: "3/4", h: "h-40 sm:h-52" }}
          b={{ src: "/assets/modes-demo/ratios/misty-2x3.jpg", label: "24×36", px: "7200 × 10800", ratio: "2:3", aspect: "2/3", h: "h-44 sm:h-56" }}
          note="Upload once. SnapToSize exports 18×24 and 24×36 at 300 DPI — the full image kept, no cropping, every file under 20MB."
        />
