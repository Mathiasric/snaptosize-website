        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground-60">
              ...
              <li>
                <Link href="/8x10-vs-11x14-print-size" className="transition-colors hover:text-accent-light">
                  8×10 vs 11×14 Size Guide
                </Link>
              </li>
              <li>
                <Link href="/8x10-vs-5x7-print-size" className="transition-colors hover:text-accent-light">
                  8×10 vs 5×7 Size Guide
                </Link>
              </li>
              <li>
                <Link href="/8x10-vs-8-5x11-print-size" className="transition-colors hover:text-accent-light">
                  8×10 vs 8.5×11 Size Guide
                </Link>
              </li>
              <li>
                <Link href="/11x14-vs-12x16-print-size" className="transition-colors hover:text-accent-light">
