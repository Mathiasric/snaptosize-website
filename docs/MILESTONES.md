...
- **SEO pages live:** 113 (page-registry.json = source of truth)
...
- ✅ 113 SEO pages live (2 new 2026-06-30: etsy-vs-shopify-digital-downloads (comparisons) + how-to-upscale-ai-art-for-etsy-prints (resolution-dpi) — /seo-research refill picks; both with RatioPackFan output-proof + Header nav; fees fact-checked vs Etsy/Shopify primary sources, +1 = frame-size-for-11x14-print-with-mat 2026-06-29)
- ✅ 110 SEO pages live (2 new pages 2026-06-28: a4-300-dpi-pixels (300 dpi cluster, 1011 imp) + print-mat-sizes-for-frames (print mat cluster, 108 imp, pos 14.6) — resolution-dpi + size-guides clusters)
