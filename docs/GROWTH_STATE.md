...
- **Paying users:** 21 — MRR ~$248 (20 monthly + 1 yearly) — +2 Pro monthly 2026-06-29, +1 Pro monthly 2026-06-12 (excl. Mathias test accounts + 1 refund (Lisa)). Confirmed churned: Kirk (May 19), Dave (May 14), Jon (May 12). Watch: Alex Higgs + Subas renewal was due 2026-05-27 — verify in Stripe; if cancelled, subtract from total.
